...
class Task:
    ...
    def get_md_task_content(self):
        return self.get_md_link(), '\n{}\n{}'.format(self.get_md_title(), self.get_md_python_solution())
...
old_md_links,old_md_task = get_file_content("linked_list.md").split("<---end.markdown links--->")
write_to_md_file("linked_list.md", merge_solution(old_md_links, old_md_task, new_md_link, new_md_task))
